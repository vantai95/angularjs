...
app.controller('LevelTestDetailController', LevelTestDetailController);
app.controller('LevelTestDetailPopUp2Controller', LevelTestDetailPopUp2Controller);

function LevelTestDetailController($ksHttp, $scope, $rootScope, $uibModal, $stateParams, $state){
	...
	$scope.openLevelTestResultLayerPopup = function(user) {
		var lvTestResultLayerPopupInstance = $uibModal.open({
			templateUrl : 'popup2',
			controller : 'LevelTestDetailPopUp2Controller',
	...
	$scope.goList = function() {
		$state.go('app.lvtest.list');
	}
	
};

function LevelTestDetailPopUp2Controller($ksHttp, $scope, $rootScope , $uibModalInstance, $filter, $state, item){
	$scope.type = 'I';
	...
	$scope.getLevelTestResultPop = function() {
		var params = {
			ltCd : $scope.lvtest.ltCd
		}
