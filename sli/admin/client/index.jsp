...
<head>
  ...
  <link rel="stylesheet" href="../../common/client/js/jquery/select2/select2.css" type="text/css" />
  <link rel="stylesheet" href="../../common/client/js/jquery/datepicker/bootstrap-datepicker.min.css" type="text/css" />
  <link rel="stylesheet" href="../../common/client/assets/css/jquery.ui.timepicker.css" type="text/css" />
  <link rel="stylesheet" href="../../common/client/assets/css/jquery-ui-1.10.0.custom.min.css" type="text/css" />
  ...
  <link rel="stylesheet" href="../../admin/client/assets/css/app.css" type="text/css" />
...
<body ng-controller="AppCtrl">
  ...
  <div class="app app-header-fixed" id="app" ng-class="{'app-header-fixed':app.settings.headerFixed, 'app-aside-fixed':app.settings.asideFixed, 'app-aside-folded':app.settings.asideFolded, 'app-aside-dock':app.settings.asideDock, 'container':app.settings.container}"
    ui-view></div>


  <!-- jQuery -->
  <script src="../../common/client/js/jquery/jquery.min.js"></script>
  <script src="../../common/client/js/jquery/moment/moment.js"></script>
  <script src="../../common/client/js/jquery/select2/select2.min.js"></script>
  <script src="../../common/client/js/libs/xlsx.full.min.js"></script>
  <script src="../../common/client/js/libs/jquery.table2excel.js"></script>
  <script src="../../common/client/js/jquery/inputmask.js"></script>
  <script src="../../common/client/js/jquery/inputmask.phone.js"></script>
  <script src="../../common/client/js/jquery/datepicker/bootstrap-datepicker.min.js"></script>
  <script src="../../common/client/js/libs/jquery.ui.timepicker.js"></script>
